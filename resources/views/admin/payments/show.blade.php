...
@section('content_page')
    <div class="col-md-8 container-data">
        <div class="box box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <label>البريد الالكترونى للدافع</label>
                <p class="text-green item-pa">
                    {{ $payment->payer_id }}
                </p>

                <label>البريد الالكترونى للمستلم</label>
                <p class="text-aqua item-pa"> {{ $payment->payee_email }}</p>

                <label>قيمة الدفوعات</label>
    ...
    <div class="col-md-4">
        ...
        <div class="card card-widget widget-user shadow">
            ...
            <div class="widget-user-header bg-secondary">
                <h3 class="widget-user-username">الدافع</h3>
            </div>
            ...
            <div class="card-footer">
                <div class="row row-statics">
                    ...
                    <a href="{{ url('admin/users/'.($payment->payer->id ?? '')) }}" class="btn btn-info">تفاصيل العضو</a>
                <!-- /.col -->
                </div>
                <!-- /.row -->
            </div>
         ...
         <div class="card card-widget widget-user shadow">
            ...
            <div class="widget-user-header bg-success">
                <h3 class="widget-user-username">مستلم الدفع</h3>
            </div>
            <div class="widget-user-image">
                <img class="img-circle elevation-2" src="https://www.kindpng.com/picc/m/78-786207_user-avatar-png-user-avatar-icon-png-transparent.png" alt="User Avatar">
            </div>
            <div class="card-footer">
                <div class="row row-statics">
                    ...
                    <a href="{{ url('admin/users/'.$payment->payee->id) }}" class="btn btn-info payee-btn">تفاصيل العضو</a>
                <!-- /.col -->
                </div>
                <!-- /.row -->
            </div>
