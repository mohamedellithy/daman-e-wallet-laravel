                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="wrapper targetDiv">
                                        <h3>{{ __('master.create_payment')}}</h3>
                                        <p>{{ __('master.create_payment_description')}}</p>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 pt-4">
                                                <div class="cd-filter-block">
                                                    ...
                                                    <div class="cd-filter-content cd-filter-block">
                                                        <label><i class="fas fa-globe"></i></label>
                                                        <input type="text" v-model="field.payer" placeholder="Email Payee">
                                                    </div>
                                                </div>
                                                <hr>
                                            </div>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <aside id="sidebar" class="sidebar mt-120 sec-bg1">
                            <div class="included c-grey mt-0">
                                ...
                                <ul>
                                    <li><i class="fas fa-check-circle"></i> {{ field.payer }}</li>
                                </ul>
                            </div>
                            ...
                            <button type="submit" class="btn btn-default-yellow-fill">{{__('master.Continue') }} <i class="fas fa-arrow-alt-circle-right"></i></button>
                        </aside>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        data(){
            return {
                field:{
                    ...
                    {
                       title:'order #2',
                       description:'order details #2',
                       quantity:3
                    },
                    {
                       title:'order #3',
                       description:'order details #3',
                       quantity:6
                    }]
                },
                errors:{},
        ...
        methods:{
            ...
            CreatePaymentOrder:function(){
                ...
                this.axios.post('payments',this.field).then(function({data}){
